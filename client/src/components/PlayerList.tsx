...
export default function PlayerList({ players, gameMasterId, sortByScore = false }: Props) {
  ...
  return (
    <div className="player-list">
      <h3 className="player-list__title">Players <span className="player-list__count">{players.length}</span></h3>
            ...
            <div className="player-card__info">
              <span className="player-card__name">
                ...
                {player.id === gameMasterId && (
                  <span className="player-card__crown" title="Game Master">♛</span>
                )}
              </span>
