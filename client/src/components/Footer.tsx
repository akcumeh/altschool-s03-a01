        ...
        <footer className="app-footer">
            <div className="app-footer__inner">
                ...
                <nav className="app-footer__links">
                    ...
                    <a href="https://github.com/akcumeh/altschool-s03-a01" target="_blank" rel="noreferrer" aria-label="GitHub">
                        <svg className="app-footer__icon" viewBox="0 0 19 19" width="20" height="20" fill="currentColor">
                            <use href="/icons.svg#github-icon" />
                        </svg>
                    </a>
                    <a href="https://twitter.com/akcumeh" target="_blank" rel="noreferrer" aria-label="X / Twitter">
                        <svg className="app-footer__icon" viewBox="0 0 19 19" width="20" height="20" fill="currentColor">
